            ...
            <div className="container">
                <div className="row res_padd">
                    <div className="footer_lft">
                        ...
                        <a href="#" className="moree">Read more <img src="images/icon32.png" alt="" /></a>
                    </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>Sarkar shoss exclusive <br />
                                        ...
                                        PO : Maynaguri,<br />
                                        Dist : Jalpaiguri, Pin : 753224.</p>
                                </li>
                                <li className="no1"><a href="#"><span><img src="images/icon34.png" alt="" /></span> <p>+91 7797813261</p></a></li>
                                <li className="no2"><a href="#"><span><img src="images/icon35.png" alt="" /></span> <p>dhrubadjs.mng@gmail.com</p></a></li>
                            </ul>
                        </div>
            ...
            <div className="copy_fot">
                <div className="container">
                    <div className="row res_padd">
                        ...
                        <ul>
                            <li>Follow us on :</li>
                            <li><a href="#"><img src="images/icon23.png" alt="" /></a></li>
                            <li><a href="#"><img src="images/icon25.png" alt="" /></a></li>
                        </ul>
                    </div>
                </div>
            </div>
